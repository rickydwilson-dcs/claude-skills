...
class TestCommandMetadata(unittest.TestCase):
    ...
    def test_parse_valid_frontmatter(self):
        ...
        cmd_file = self.fixtures_dir / 'code.review-pr.md'
        metadata = CommandMetadata(cmd_file)

        self.assertEqual(metadata.metadata['name'], 'code.review-pr')
        self.assertEqual(metadata.metadata['category'], 'code')
    ...
    def test_filename_extraction(self):
        ...
        self.assertEqual(metadata.filename, 'code.review-pr')
...
class TestValidationChecks(unittest.TestCase):
    ...
    def test_check_4_pattern_validity_simple(self):
        ...
        cmd_file = self.fixtures_dir / 'docs.update-readme.md'
        metadata = CommandMetadata(cmd_file)
    ...
    def test_check_4_pattern_validity_agent_style(self):
        ...
        cmd_file = self.fixtures_dir / 'architecture.design-review.md'
        metadata = CommandMetadata(cmd_file)
...
class TestFullValidation(unittest.TestCase):
    ...
    def test_valid_command_passes_all_checks(self):
        """Test that code.review-pr.md passes all validation"""
        cmd_file = self.fixtures_dir / 'code.review-pr.md'
    ...
    def test_simple_pattern_passes_all_checks(self):
        """Test that docs.update-readme.md passes all validation"""
        cmd_file = self.fixtures_dir / 'docs.update-readme.md'
        is_valid, errors = self.validator.validate_command(cmd_file)
    ...
    def test_agent_style_pattern_passes_all_checks(self):
        """Test that architecture.design-review.md passes all validation"""
        cmd_file = self.fixtures_dir / 'architecture.design-review.md'
        is_valid, errors = self.validator.validate_command(cmd_file)
