# How to Use the Senior Fullstack Skill

## Quick Start

Hey Claude—I just added the "senior-fullstack" skill. Can you analyze my current codebase?
...
```
Hey Claude—I just added the "senior-fullstack" skill. Can you help me with new project setup?
```

### Example 3: Integration with Other Skills
```
Hey Claude—I just added the "senior-fullstack" skill. Can you use it together with related skills to deliver a complete solution?
```
...
- **Codebase**: Link to repository or description of application
- **Context** (optional): Project goals, technology stack
- **Focus Areas** (optional): Specific features or problems to address
...
- **fullstack_scaffolder.py**: Fullstack Scaffolder
- **project_scaffolder.py**: Project Scaffolder

You can run these tools directly:

```bash
python skills/engineering-team/senior-fullstack/scripts/code_quality_analyzer.py --help
```
