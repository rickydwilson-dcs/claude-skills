...
### General Category (Speckit Workflow)

Commands for specification-driven development workflow:

**Available Commands:**
- [`speckit.specify`](.claude/commands/speckit.specify.md) - Create or update feature specification from natural language
- [`speckit.clarify`](.claude/commands/speckit.clarify.md) - Identify underspecified areas with targeted questions
- [`speckit.plan`](.claude/commands/speckit.plan.md) - Execute implementation planning workflow using plan template
- [`speckit.tasks`](.claude/commands/speckit.tasks.md) - Generate actionable, dependency-ordered task list
- [`speckit.implement`](.claude/commands/speckit.implement.md) - Execute implementation plan by processing tasks
- [`speckit.analyze`](.claude/commands/speckit.analyze.md) - Cross-artifact consistency and quality analysis
- [`speckit.checklist`](.claude/commands/speckit.checklist.md) - Generate custom checklist for current feature
- [`speckit.constitution`](.claude/commands/speckit.constitution.md) - Create or update project constitution

**Pattern:** Comprehensive specification-to-implementation workflow
**Use Case:** Complete feature development from concept to code
...
**Available Commands:**
- [`analysis.code-review`](analysis/analysis.code-review.md) - Comprehensive code review with quality analysis
- [`analysis.security-audit`](analysis/analysis.security-audit.md) - OWASP Top 10 scan + secrets detection + vulnerability analysis
- [`analysis.dependency-audit`](.claude/commands/analysis.dependency-audit.md) - Check for outdated/vulnerable dependencies with multi-phase analysis
- [`analysis.refactor-plan`](analysis/analysis.refactor-plan.md) - Generate refactoring recommendations and implementation plan
...
**Available Commands:**
- [`generation.test-generate`](generation/generation.test-generate.md) - Intelligent test case generation from existing code with coverage analysis
- [`generation.api-document`](.claude/commands/generation.api-document.md) - Automatic API documentation generation with OpenAPI/Swagger specs
...
**Available Commands:**
- [`git.commit-assist`](git/git.commit-assist.md) - Intelligent commit message generation following conventions
- [`git.branch-cleanup`](git/git.branch-cleanup.md) - Clean up merged and stale branches
...
**Available Commands:**
- [`workflow.pr-create`](workflow/workflow.pr-create.md) - Create pull request with comprehensive description
- [`workflow.update-docs`](workflow/update-docs.md) - Update documentation with latest repository information
- [`workflow.feature-prioritize`](workflow/feature-prioritize.md) - Prioritize features using scoring framework
...
**Available Commands:**
- [`test.sample-command`](test/test.sample-command.md) - Sample test command for development
...
- [`git.commit-assist`](git/git.commit-assist.md) - Generate conventional commit message (< 1 min)
- [`git.branch-cleanup`](git/git.branch-cleanup.md) - Clean up merged branches (< 1 min)
- [`workflow.update-docs`](workflow/update-docs.md) - Update documentation files (< 1 min)
- [`test.sample-command`](test/test.sample-command.md) - Sample command (< 1 min)

### Multi-Phase Commands

**Speckit Workflow (8 commands):**
- [`speckit.specify`](.claude/commands/speckit.specify.md) - Feature specification (2-5 min)
- [`speckit.clarify`](.claude/commands/speckit.clarify.md) - Clarification questions (1-3 min)
- [`speckit.plan`](.claude/commands/speckit.plan.md) - Implementation planning (3-7 min)
- [`speckit.tasks`](.claude/commands/speckit.tasks.md) - Task generation (2-4 min)
- [`speckit.implement`](.claude/commands/speckit.implement.md) - Execute tasks (5-30 min)
- [`speckit.analyze`](.claude/commands/speckit.analyze.md) - Cross-artifact analysis (2-5 min)
- [`speckit.checklist`](.claude/commands/speckit.checklist.md) - Custom checklist (1-2 min)
- [`speckit.constitution`](.claude/commands/speckit.constitution.md) - Project principles (3-5 min)

**Analysis Commands:**
- [`analysis.code-review`](analysis/analysis.code-review.md) - Code review with quality analysis (3-7 min)
- [`analysis.security-audit`](analysis/analysis.security-audit.md) - Security vulnerability scan (5-10 min)
- [`analysis.dependency-audit`](.claude/commands/analysis.dependency-audit.md) - Dependency analysis (3-6 min)
- [`analysis.refactor-plan`](analysis/analysis.refactor-plan.md) - Refactoring recommendations (4-8 min)

**Generation Commands:**
- [`generation.test-generate`](generation/generation.test-generate.md) - Test case generation (2-5 min)
- [`generation.api-document`](.claude/commands/generation.api-document.md) - API documentation (3-7 min)

**Workflow Commands:**
- [`workflow.pr-create`](workflow/workflow.pr-create.md) - Pull request creation (2-4 min)
- [`workflow.feature-prioritize`](workflow/feature-prioritize.md) - Feature prioritization (3-5 min)
...
**Current Status:**
- Total Commands: 20
- Passing All Checks: 20 (estimated - validation tool pending)
- Validation Rate: 100%
