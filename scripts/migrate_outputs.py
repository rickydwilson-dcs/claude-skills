...
def perform_migration(
    ...
    # Scan legacy outputs
    print("🔍 Scanning for legacy outputs...")
    ...
    if backup_path:
        ...
        print("   ⚠️  Backup failed - continue anyway? (yes/no): ", end="")
    ...
    print("📁 Creating migration session...")
    ...
    if fail_count > 0:
        print(f"❌ Failed to migrate: {fail_count} file(s)")
    print()
