...
docs/implementation/implementation-plan-november-2025.md
docs/delivery/sprint-11-05-2025/context.md

# Implementation/Summary Documents (goes in docs/implementation/)
docs/implementation/commands-implementation.md
docs/implementation/qa-validation-report.md
docs/implementation/agent-builder-implementation.md

# User Guides (goes in docs/)
docs/COMMANDS_INSTALLATION.md
docs/COMMANDS_CREATION.md
docs/AGENTS_CATALOG.md
docs/SKILLS_CATALOG.md
```

### **Where to Place Implementation Documents**

**Implementation Summaries and Technical Reports:**
```
docs/implementation/
├── commands-implementation.md      # Command system implementation
├── agent-builder-implementation.md # Agent builder tool
├── skill-builder-implementation.md # Skill builder tool
└── qa-validation-report.md         # QA/validation reports
```

**User-Facing Guides:**
```
docs/
├── COMMANDS_INSTALLATION.md    # Installation guides (UPPERCASE pattern)
├── COMMANDS_CREATION.md        # Creation guides (UPPERCASE pattern)
├── AGENTS_CATALOG.md           # Catalogs (UPPERCASE pattern)
├── SKILLS_CATALOG.md           # Catalogs (UPPERCASE pattern)
├── INSTALL.md                  # General installation
├── USAGE.md                    # General usage
└── WORKFLOW.md                 # Workflow guides
```

**Never Place in Repository Root:**
- ❌ INSTALL_COMMANDS_IMPLEMENTATION.md (too specific, clutters root)
- ❌ QA_VALIDATION_REPORT.md (internal document)
- ❌ COMMANDS_DOCUMENTATION_SUMMARY.md (internal summary)
- ✅ These belong in `docs/implementation/`
```
