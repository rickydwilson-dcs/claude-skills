...
examples:
  - title: "Basic Usage"
    input: "/test.sample-command"
    output: "Command executed successfully"
  - title: "Advanced Usage"
    input: "/test.sample-command --verbose"
...
**Solution:** Verify file exists at commands/test/test.sample-command.md
